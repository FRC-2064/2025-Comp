...
public class ReefLookup {
        ...
        static {
                algaePoses.put(ControlBoardConstants.REEF_LOCATION_A, new AlgaePair(
                                OTFPaths.ALGAE_END_LOCATION_AB,
                                AlgaeHeight.HIGH));
                ...
                algaePoses.put(ControlBoardConstants.REEF_LOCATION_C, new AlgaePair(
                                OTFPaths.ALGAE_END_LOCATION_CD,
                                AlgaeHeight.LOW));
                ...
                algaePoses.put(ControlBoardConstants.REEF_LOCATION_E, new AlgaePair(
                                OTFPaths.ALGAE_END_LOCATION_EF,
                                AlgaeHeight.HIGH));
                ...
                algaePoses.put(ControlBoardConstants.REEF_LOCATION_G, new AlgaePair(
                                OTFPaths.ALGAE_END_LOCATION_GH,
                                AlgaeHeight.LOW));
        ...
        static {
                coralPoses.put(ControlBoardConstants.REEF_LOCATION_A, OTFPaths.CORAL_END_LOCATION_A);
                coralPoses.put(ControlBoardConstants.REEF_LOCATION_B, OTFPaths.CORAL_END_LOCATION_B);
                coralPoses.put(ControlBoardConstants.REEF_LOCATION_C, OTFPaths.CORAL_END_LOCATION_C);
                coralPoses.put(ControlBoardConstants.REEF_LOCATION_D, OTFPaths.CORAL_END_LOCATION_D);
                coralPoses.put(ControlBoardConstants.REEF_LOCATION_E, OTFPaths.CORAL_END_LOCATION_E);
                coralPoses.put(ControlBoardConstants.REEF_LOCATION_F, OTFPaths.CORAL_END_LOCATION_F);
                coralPoses.put(ControlBoardConstants.REEF_LOCATION_G, OTFPaths.CORAL_END_LOCATION_G);
                coralPoses.put(ControlBoardConstants.REEF_LOCATION_H, OTFPaths.CORAL_END_LOCATION_H);
                coralPoses.put(ControlBoardConstants.REEF_LOCATION_I, OTFPaths.CORAL_END_LOCATION_I);
                coralPoses.put(ControlBoardConstants.REEF_LOCATION_J, OTFPaths.CORAL_END_LOCATION_J);
                coralPoses.put(ControlBoardConstants.REEF_LOCATION_K, OTFPaths.CORAL_END_LOCATION_K);
                coralPoses.put(ControlBoardConstants.REEF_LOCATION_L, OTFPaths.CORAL_END_LOCATION_L);      
        }

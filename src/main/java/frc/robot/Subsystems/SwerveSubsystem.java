...
public class SwerveSubsystem extends SubsystemBase {
    ...
    private String currentPath = "";
        ...
        public void periodic() {
            SmartDashboard.putString("currPath", currentPath);
    ...
    public Command goToScore() {
        System.out.println("in Drive goToScore");
    ...
    public Command goToCage() {
        System.out.println("in Drive goToCage");
        return new InstantCommand(() -> {
    ...
    public Command goToFeeder() {
        System.out.println("in Drive goToFeeder");
        return new InstantCommand(() -> {
